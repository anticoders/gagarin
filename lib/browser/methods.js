...
module.exports.execute = function (code, args) {
  ...
  return self.__custom__(function (operand, done) {
    ...
    operand.browser.execute("return (" + wrapSourceCode(codeToString(code), clean(this, args), closure) + ").apply(null, arguments)",
...
module.exports.promise = function (code, args) {
  ...
  return self.__custom__(function (operand, done) {
    ...
    var myArgs = clean(this, args).map(stringify); // stringify arguments

    myArgs.unshift("function ($) { setTimeout(function () { cb({ closure: closure(), error: ($ && typeof $ === 'object') ? $.message : $.toString() }) }) }");
    myArgs.unshift("function ($) { setTimeout(function () { cb({ closure: closure(), value: $ }) }) }");
...
module.exports.wait = function (timeout, message, code, args) {
  ...
  return self.__custom__(function (operand, done) {
    ...
    var myArgs = clean(this, args).map(stringify);
