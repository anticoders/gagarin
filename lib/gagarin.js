...
var MeteorAsPromise      = require('./gagarinAsPromise');
...
function Meteor (options) {
  ...
  var meteorAsPromise = new MeteorAsPromise(options, Promise.all([
    ...
    return new Promise(function (resolve, reject) {
      ...
      function requestMeteorProcess (meteorNeedRestart, meteorRestartTimeout) {
      ...
      //----------------------------------------------------
      resolve(new MeteorTransponder(requestMeteorProcess, {
        cleanUp: function () {
  ...
  meteorAsPromise.location = options.location;
