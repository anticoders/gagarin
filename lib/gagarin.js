...
function Gagarin (gagarinOptions) {
  ...
  this.suite.on('pre-require', function (context) {
    ...
    context.meteor = function (options, initialize) {
      ...
      var myHelpers = mergeHelpers({}, gagarinOptions.serverHelpers);
      ...
      var meteor = new Meteor({
        ...
        helpers   : mergeHelpers(myHelpers, options.serverHelpers || helpers.server),
      });
    ...
    context.browser = function (options, initialize) {
      ...
      var myHelpers = mergeHelpers({}, gagarinOptions.clientHelpers);
      ...
      var browser  = new Browser({
        ...
        helpers   : mergeHelpers(myHelpers, options.clientHelpers || helpers.client),
      });
