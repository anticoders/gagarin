...
function Gagarin (gagarinOptions) {
  ...
  this.suite.on('pre-require', function (context) {
    ...
    context.meteor = function (options, initialize) {
      ...
      var helpers = mergeHelpers({}, gagarinOptions.serverHelpers);
      ...
      var meteor = new Meteor({
        ...
        helpers   : mergeHelpers(helpers, options.serverHelpers),
      });
    ...
    context.browser = function (options, initialize) {
      ...
      var helpers = mergeHelpers({}, gagarinOptions.clientHelpers);
      ...
      var browser  = new Browser({
        ...
        helpers   : mergeHelpers(helpers, options.clientHelpers),
      });
