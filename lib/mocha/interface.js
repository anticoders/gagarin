...
Mocha.interfaces['gagarin'] = module.exports = function (suite) {
  ...
  suite.on('pre-require', function (context) {
    ...
    context.fixtures = {
      registerFile: fixtures.registerFile.bind(fixtures),
    };
    ...
    context.meteor = function (options, onStart) {
      ...
      if (options.mocha) {
        ...
        meteor.useFixture('built-in/browser-source-map-support.js', 'client');
        meteor.useFixture('built-in/mocha.js', 'client');
        meteor.useFixture('built-in/mocha-for-gagarin.js');
      }
