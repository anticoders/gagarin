  ...
  suite.on('pre-require', function (context) {
    ...
    context.meteor = function (options, initialize) {
      ...
      if (options.flavor == "fiber") {
        ...
        proxy._ddpSetupProvider = meteor._ddpSetupProvider;
        return proxy;
      } else {
        return meteor;
      }
    ...
    context.browser = function (options, initialize) {
      ...
      if (options && options._ddpSetupProvider) {
        options = { location: options };
      }
    ...
    context.ddp = function (server, options) {
      ...
      var makeDDPClient = require('../ddp/makeDDPClient');
    ...
    context.mongo = function (options) {
      ...
      var makeMongoDB = require('../mongo/makeMongoDB');
