...
Mocha.interfaces['gagarin'] = module.exports = function (suite) {
  ...
  suite.on('pre-require', function (context) {
    ...
    context.meteor = function (options, onStart) {
      ...
      if (options.mocha) {
        meteor.addJavaScript('client', fs.readFileSync(path.resolve(__dirname, '../../node_modules/mocha/mocha.js'), 'utf8'));
        
        meteor.addJavaScript('server', fixtures.get('mocha'));
        meteor.addJavaScript('client', fixtures.get('mocha'));
      }
