...
function BuildPromise(options) {
  ...
  return tools.getReleaseVersion(pathToApp).then(function (version) { return new Promise(function (resolve, reject) {
    ...
    var platformsFilePath = pathToApp +'/.meteor/platforms';
    fs.rename(platformsFilePath,pathToApp+'/.meteor/platforms.gagarin.backup',function(err,data){
    ...
    meteor.on('exit', function onExit (code) {
      ...
      fs.rename(pathToApp+'/.meteor/platforms.gagarin.backup',pathToApp +'/.meteor/platforms');
      if (code) {
