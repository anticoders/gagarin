...
module.exports = function BuildAsPromise (options) {
  ...
  var smartPackagesOrMongoServerAsPromise = fs.existsSync(pathToSmartJson) ?
    tools.smartPackagesAsPromise(pathToApp) :
    MongoServerAsPromise({ pathToApp: pathToApp });

  myBuildPromises[pathToApp] = smartPackagesOrMongoServerAsPromise.then(function () {
