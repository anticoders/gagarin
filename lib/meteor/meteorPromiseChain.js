...
var either  = require('../tools/tools').either;
...
function MeteorPromiseChain (operand, helpers) {
  ...
  Object.keys(helpers).forEach(function (key) {
    if (self[key] !== undefined) {
      console.warn('helper ' + key + ' conflicts with some MeteorPromiseChain method');
    }
...
MeteorPromiseChain.methods = meteorRemoteMethods.concat([
  'catch',
  'then',
  'always',
  'sleep',
...
meteorRemoteMethods.forEach(function (name) {
  "use strict";
