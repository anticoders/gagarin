    ...
    meteorPromise = new Promise(function (resolve, reject) {
      ...
      cleanUpThen(function () {
        ...
        (meteorPort ? Promise.resolve(meteorPort) : findAvailablePort()).then(function (port) {
          ...
          var dest = path.join(options.pathToApp || module.exports.getUserHome(), '.gagarin','copy');
          ...
          function spawnProcess () {
            setTimeout(function () {
              meteorProcess = new createMeteorProcess(pathToNode, dest+'/main.js', env, meteorProcessPrototype, options);
            }, meteorRestartDelay);
          }
