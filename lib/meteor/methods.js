...
module.exports.promise = function (code, args) {
  ...
  return this.__custom__(function (operand, cb) {
    ...
    callDDPMethod(ddpClient, '/gagarin/promise', [ closure(), code.toString(), clean(this, args) ], closure, cb);
...
module.exports.execute = function (code, args) {
  ...
  return this.__custom__(function (operand, cb) {
    ...
    callDDPMethod(ddpClient, '/gagarin/execute', [ closure(), code.toString(), clean(this, args) ], closure, cb);
...
module.exports.wait = function (timeout, message, code, args) {
  ...
  return this.__custom__(function (operand, cb) {
    ...
    callDDPMethod(ddpClient, '/gagarin/wait', [ closure(), timeout, message, code.toString(), clean(this, args) ], closure, cb);
...
module.exports.mocha = function () {
  ...
  }, [ function () { return this.lastResult; } ]).wait(1000, 'until status is connected', function () {
