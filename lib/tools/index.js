...
module.exports = {
  ...
  //TODO: This is a rather troublesum helper method and needs better logging (probably with some --verbose degree setting)
  either: function (reject, originalError) {
    // console.log("reject, originalError", reject, originalError)
    return {
      or: function (resolve) {
