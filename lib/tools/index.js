...
module.exports = {
  ...
  getReleaseName: _(function (pathToApp) {
    "use strict";
  ...
  getReleaseVersion: _(function (pathToApp) {
    "use strict";
  ...
  getPathToDevBundle: _(function (releaseName) {
    "use strict";
    ...
    return new Promise(function (resolve) {
      Fiber(function () {
        resolve(path.join(getMeteorToolPath(home, version), 'dev_bundle'));
      }).run();
    });

  }).memoize(),

  getReleaseConfig: _(function (version) {
    "use strict";
  ...
  getMongoPath: _(function (pathToApp) {
    "use strict";
  ...
  getNodePath: _(function (pathToApp) {
    "use strict";
    return module.exports.getReleaseName(pathToApp)
      .then(function (releaseName) {
        return module.exports.getPathToDevBundle(releaseName)
