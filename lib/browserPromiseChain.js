...
BrowserPromiseChain.prototype.execute = function (code, args) {
  ...
  return self.apply('execute', arguments, function (operand, name, myArgs) {
...
BrowserPromiseChain.prototype.promise = function (code, args) {
  ...
  return self.setAsyncScriptTimeout(self._timeout || 5000).apply('executeAsync', arguments, function (operand, name, myArgs) {
...
BrowserPromiseChain.prototype.wait = function (timeout, message, code, args) {
  ...
  return self.setAsyncScriptTimeout(2 * timeout).apply('executeAsync', arguments, function (operand, name, myArgs) {
...
// TODO: implement these two guys

//BrowserPromiseChain.prototype.findElementAndClick = function (selector, keys, cb) {
//  "use strict";
//
//};

//BrowserPromiseChain.prototype.findElementAndSendKeys = function (selector, keys, cb) {
//  "use strict";
//
//};
