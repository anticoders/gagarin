...
Mocha.interfaces['gagarin'] = module.exports = function (suite) {
  ...
  suite.on('pre-require', function (context) {
    ...
    context.meteor = function (options, initialize) {
      ...
      var wrappingMethods = ['execute']
      return (options.fiber)? wrapPromisesForFiber(meteor, wrappingMethods) : meteor;
    }
    ...
    context.browser = function (options, initialize) {
      ...
      var wrappingMethods = ['execute']
      return (options.fiber)? wrapPromisesForFiber(browser, wrappingMethods) : browser;
    }
