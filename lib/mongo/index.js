...
module.exports = function makeMongoDB (options, helpers) {
  ...
  MongoDB.prototype = Object.create(new MongoGeneric(), {
    methods: {
      value: [].concat(
        Object.keys(myPrototype),
        Object.keys(helpers),
        MongoGeneric.prototype.methods
      )
    }
  });

  /**
   * Return a promise that will resolve to a mongoUrl.
   */
   MongoDB.prototype.getMongoUrl = function getMongoUrl () {
    return this._promise.then(function (operand) {
      return operand.mongoUrl;
    });
  }
